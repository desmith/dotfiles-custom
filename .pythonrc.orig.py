...
readline.set_history_length(1600)
...
#################
WELCOME = """
%(LightBlue)s The Python shell is coming at 'ya, punk!
%(Cyan)s You've got color, history, and pretty printing.
(If your ~/.inputrc doesn't suck, you've also
got completion and vi-mode keybindings.)
%(Brown)s Type \e to get an external editor.
%(Blue)s Oh yeah, it is that cool.
%(Normal)s""" % _c
...
if 'DJANGO_SETTINGS_MODULE' in os.environ:
    ...
    * The Django test client is available as `C`.
    ...
    Warning:
        the Django test environment has been set up;
        to restore the normal environment call `teardown_test_environment()`.
        Warning: DEBUG_PROPAGATE_EXCEPTIONS has been set to True. %(Normal)s""" % _c
