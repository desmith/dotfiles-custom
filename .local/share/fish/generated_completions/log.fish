...
complete -c log -l device --description 'Collect system logs from paired device (first device found).'
complete -c log -l device-name --description 'Collect system logs from paired device with the given name.'
complete -c log -l device-udid --description 'Collect system logs from paired device with the given UDID.'
...
complete -c log -l pager --description 'Enable or disable pagination of output via less.'
...
complete -c log -l style --description 'Control the output formatting of events: -tag -width "default " default Human…'
complete -c log -l color --description 'Control the display of colorized output.'
