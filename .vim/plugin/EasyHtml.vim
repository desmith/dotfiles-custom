...
" then :
" 		- Press <F4> key to display attributes for the tag before/under the
" 		cursor
" 		- Press <F5> key to display values for the attribute before/under the
" 		cursor
" 		- Press <F6> ket to display values for the CSS Property befor/under
" 		the cursor
"
"
...
"
" Useful mappings :
"   . d<F4> : delete tag before/under cursor
"   . d<F5> : delete attribute before/under cursor
"
"-----------------------------------------------------------------------------
" Updates:
" in version 0.5.1
...
"   Make script smaller.
" - Mapping changed !
"   <F4> displays tag attributes
"   <F5> displays attributes values
"   <F6> displays CSS Properties values
...
"   hitting <F4>, <F5> or <F6> keys.
"   For example,
"   . Tags : <img
"     Hitting <F4> key works while cursor is at '<' sign.
"   . Attributes : style=""
"     Hitting <F5> key works while cursor is at '=' or '"' signs.
"   . CSS properties : background-color:;
"     Hitting <F6> key works while cursor is at ':' or ';' signs.
" - New mappings :
"   . d<F4> : delete tag before/under cursor
"   . d<F5> : delete attribute before/under cursor
...
"  - Now, display values list when hitting <F5> with cursor on attribute word
...
" - Hitting <F5> allows to display attributes list in Insert mode too
...
nm <C-S-Left> d<F6>
" Right move attribut
nm <C-S-Right> d<F6>/ \\|><cr>:nohl<cr>P
" Tag attributes list
nm <F4> :cal LaunchEasyHtml('<')<cr>
im <F4> <esc><F4>a
" Attributes values list
nm <F5> :cal LaunchEasyHtml('\s')<cr>
im <F5> <esc><F5>a
" Style attribut values list
nm <F6> :cal LaunchEasyHtml('\(\s\\|"\\|;\)[a-zA-Z-]\+:')<cr>
im <F6> <esc><F6>a
